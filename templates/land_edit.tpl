...
<script type="text/javascript" src="/common/handlers2.js?xc=5"></script>
<script type="text/javascript" src="/common/house.js?vx5=445c"></script>
<script>
...
$(document).ready(function() {
	...
	swfuRealty = new SWFUpload({
		...
		post_params: {"PHPSESSID": "{/literal}{$session_id}{literal}","kind":"5"},
		...
		button_width: 300,
		button_height: 18,
		button_text : '<span class="button">Выберите фотографии земельного участка <span class="buttonSmall">(6 MB Max)</span></span>',
